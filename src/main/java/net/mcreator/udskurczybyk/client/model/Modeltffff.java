...
public class Modeltffff<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("ud_skurczybyk", "modeltffff"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone3 = partdefinition.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(16, 16).addBox(-3.0F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(1.0F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
		...
		PartDefinition bone4 = partdefinition.addOrReplaceChild("bone4", CubeListBuilder.create().texOffs(16, 16).addBox(-1.0F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(1.0F)), PartPose.offset(5.0F, 2.0F, 0.0F));
		PartDefinition bone2 = partdefinition.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, 1.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(1.01F)).texOffs(24, 0).addBox(-5.0F, 0.0F, -3.1F, 10.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(14, 32)
						.addBox(-4.4F, 5.0F, -3.1F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(32, 14).addBox(0.5F, 5.0F, -3.1F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
